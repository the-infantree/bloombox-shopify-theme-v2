...
/* Check if user agent is the app (GoNative) */
if (navigator.userAgent.indexOf('gonative') > -1) {

    /* if app add a back button */
    document.getElementById("btn--back").addEventListener("click", () => {
        history.back();
    });

    /* if app add a body class */
    var body = document.body;
    body.classList.add("app");

    /* if app display coupon popup */
    var appModal = document.getElementById("app-promo");
    appModal.innerHTML =
        '<img src="https://cdn.shopify.com/s/files/1/0457/4632/3611/files/icon-hand-selected.svg?v=1610158358" alt="" width="80" role="presentation"><h2 class="h4">Thanks for downloading our app!</h2><p>Enjoy $5 off your next order using promo code <strong class="h3">APPTHX</strong><br><a href="/pages/app-promo">Get your coupon emailed.</a></p><p><small>One use per customer. Cannot be combined with other offers. This form will NOT subscribe you to BloomBox marketing or promotional emails.</small></p><button class="modal__promo-close" onClick="PopUp(&apos;hide&apos;)">Close</button>';

    window.onload = function () {
        console.log("Checking if cookie exists...");
        if (document.cookie.indexOf("appPromoCoupon") === -1) {
            setTimeout(function () {
                console.log("Cookie does not exist. Show popup.");
                PopUp("show");
            }, 1);
        } else {
            console.log("Cookie exists. Do nothing.");
        }
    };
    function PopUp(hideOrshow) {
        ...
        } else if (document.cookie.indexOf("appPromoCoupon") === -1) {
            console.log("popup(show);");
            document.getElementById("promo-wrapper").removeAttribute("style");
            document.cookie = "appPromoCoupon=true";
        }
    }
    ...
    Slideshow.prototype = Object.assign({}, Slideshow.prototype, {
        ...
        _getActiveSlidesIndex: function () {
            var currentActiveSlides = this.slides.filter(function (sliderItem) {
                if (
                    sliderItem.classList.contains(this.options.slideActiveClass)
                ) {
                    return sliderItem;
                }
            }, this);
        ...
        document
            ...
            .forEach(function (button) {
                button.addEventListener("click", function () {
                    var isExpanded =
                        newAddressFormButton.getAttribute("aria-expanded") ===
                        "true";
    ...
    Cart.prototype = Object.assign({}, Cart.prototype, {
        ...
        _createCartDiscountList: function (cart) {
            return cart.cart_level_discount_applications.map(
                function (discount) {
                    var discountNode =
                        this.cartDiscountTemplate.cloneNode(true);
        ...
        _createLineItemList: function (state) {
            return state.items.map(
                function (item, index) {
                    ...
                    var itemPriceList =
                        this.itemPriceListTemplate.cloneNode(true);
        ...
        _getPropertyList: function (properties) {
            ...
            var filteredPropertiesArray = propertiesArray.filter(function (
                property
            ) {
            ...
            return filteredPropertiesArray.map(
                function (property) {
                    var propertyElement =
                        this.itemPropertyTemplate.cloneNode(true);
        ...
        _createItemDiscountList: function (item) {
            return item.line_level_discount_allocations.map(
                function (discount) {
                    var discountNode =
                        this.itemDiscountTemplate.cloneNode(true);
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
        ...
        _initAddToCart: function () {
            ...
            productForm.addEventListener(
                ...
                function (evt) {
                    if (
                        this.addToCart.getAttribute("aria-disabled") === "true"
                    ) {
                        evt.preventDefault();
                        return;
                    }
        ...
        _adjustThumbnailSlider: function (activeThumbnail) {
            ...
            var slideGroupLeaderIndex =
                Math.floor(
                    Number(sliderItem.getAttribute("data-slider-slide-index")) /
                        3
                ) * 3;
    ...
    theme.SlideshowSection.prototype,
    {
        ...
        _onSliderSlideChanged: function (slideIndex) {
            ...
            this.sliderMobileContentIndex.forEach(function (element) {
                if (
                    Number(
                        element.getAttribute("data-slider-mobile-content-index")
                    ) === slideIndex
                ) {
    ...
    StoreAvailability.prototype = Object.assign(
        ...
        StoreAvailability.prototype,
        {
            ...
            _updateProductTitle: function () {
                ...
                storeAvailabilityModalProductTitle.textContent =
                    this.productTitle;
            },
            ...
            _hideVariantTitle: function () {
                ...
                storeAvailabilityModalVariantTitle.classList.add(
                    classes.hidden
                );
            },
        }
    ...
    document.addEventListener("lazyloaded", function (evt) {
        ...
        if (document.body.classList.contains("template-index")) {
            ...
            if (
                ...
                var firstSection =
                    document.getElementsByClassName("index-section")[0];
...
waitForElement("#rbz-zipcode-success", 0)
    .then(function () {
        var zipModal = document.getElementById("pw-app-modal");
        zipModal.setAttribute("tabindex", "0");
        zipModal.focus();
    })
    .catch(() => {});

waitForElement("#rbz-zipcode-success", 100000)
    .then(function () {
        var zipSuccessButton = document.querySelector(
            "#rbz-zipcode-success button"
        );
        var exploreButton = document.querySelector("button.pw-app-email-done");

        var deliveryButton = document.querySelector("#nav_delivery_indicator");
        var deliveryButtonMobile = document.querySelector(
            "#header_delivery_indicator"
        );
        ...
        zipSuccessButton.onclick = function () {
            refreshPage();
            scrollUnlock();
        };
        ...
        deliveryButtonMobile.onclick = function () {
            scrollLock();
        };
    })
    .catch(() => {});

// END  Zip Code Popup functions

// adds #filter to end of collection filter tag link URLs
var tagLink = document.querySelectorAll("a.tag-toggle, .filter-tag a");
for (var i = 0; i < tagLink.length; i++) {
    var tagURL = tagLink[i].getAttribute("href");
    var tagJumpURL = tagURL + "#filter";
    tagLink[i].setAttribute("href", tagJumpURL);
}
